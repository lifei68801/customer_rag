  ...
  return (
    <div className="flex min-h-dvh flex-col bg-paper">
      ...
      <nav className="flex items-center justify-between border-b-2 border-ink bg-accent-yellow px-6 py-4">
        ...
        <Link
          to="/admin"
          className={`flex min-h-[44px] cursor-pointer items-center gap-1.5 border-2 border-ink bg-paper px-3 py-1.5 text-sm font-bold text-ink shadow-soft-sm transition active:translate-x-px active:translate-y-px active:shadow-none ${focusRing}`}
        >
          <GearIcon />
          管理后台
        </Link>
