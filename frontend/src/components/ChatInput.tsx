  ...
  return (
    ...
    >
      <input
        ...
        placeholder="输入你的问题…"
        disabled={disabled}
        className="flex-1 rounded-control border border-subtle bg-paper px-4 py-2.5 text-ink placeholder:text-ink-soft focus:shadow-soft focus:outline-none disabled:opacity-50"
      />
      <button
        type="submit"
