...
export function EntityMappingEditor({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-card border border-subtle bg-paper p-3">
      ...
      <label className="flex flex-col gap-1 text-sm font-bold text-ink">
        ...
        <select
          ...
          className={`rounded-control border border-subtle bg-card px-2 py-1.5 text-ink focus:outline-none ${focusRing}`}
        >
      ...
      <label className="flex flex-col gap-1 text-sm font-bold text-ink">
        ...
        <select
          ...
          className={`rounded-control border border-subtle bg-card px-2 py-1.5 text-ink focus:outline-none disabled:opacity-50 ${focusRing}`}
        >
      ...
      <div className="flex flex-col gap-2">
        ...
        <button
          ...
          className={`self-start rounded-control border border-subtle bg-card px-3 py-1.5 text-xs font-bold text-ink ${focusRing}`}
        >
          + 添加另一列（组成复合 key）
        </button>
      </div>
