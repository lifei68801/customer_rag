  ...
  return (
    ...
    >
      ...
      {mounted && (
        <span
          role="tooltip"
          className={`pointer-events-none absolute bottom-full left-1/2 z-40 mb-1.5 -translate-x-1/2 whitespace-nowrap border border-subtle bg-ink px-2 py-1 text-xs font-bold text-paper shadow-soft-sm transition-opacity duration-150 motion-reduce:transition-none ${
