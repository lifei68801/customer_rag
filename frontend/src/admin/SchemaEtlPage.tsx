...
export function SchemaEtlPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {confirmed === false && (
        <div className="border-2 border-ink bg-accent-yellow px-3 py-2 text-sm text-ink shadow-soft-sm">
          该租户本体 schema 尚未确认，请先完成本体 schema 确认后再触发 ETL。
        </div>
      )}

      <div className="flex flex-col gap-2 border-2 border-ink bg-card shadow-soft-sm">
        <button
          type="button"
              ...
              {sampleFiles && sampleFiles.length > 0 && (
                <>
                  <div className="flex flex-wrap gap-2">
                    {sampleFiles.map((file) => (
                      <button
                        ...
                        className={`border-2 border-ink px-3 py-1.5 text-xs font-bold text-ink shadow-soft-sm ${
                  ...
                  <button
                    ...
                    className={`self-start border-2 border-ink bg-paper px-4 py-2 text-sm font-bold text-ink shadow-soft-sm transition active:translate-x-px active:translate-y-px active:shadow-none disabled:cursor-not-allowed disabled:opacity-50 ${focusRing}`}
                  >
        ...
        <div className="flex flex-col gap-3 border-2 border-ink bg-card p-4 shadow-soft">
          ...
          {selectedRun.report && (
            <>
              ...
              <div className="overflow-x-auto border-2 border-ink shadow-soft-sm">
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b-2 border-ink bg-paper text-ink">
