  ...
  return (
    <div className="relative flex-1">
      <input
        ...
        className="w-full border border-subtle bg-paper px-3 py-2 text-ink placeholder:text-ink-soft focus:shadow-soft focus:outline-none"
      />
      {isOpen && (suggestions.length > 0 || showCreateNew) && (
        <ul className="absolute z-10 mt-1 w-full border border-subtle bg-paper shadow-soft-sm">
