    ...
    <ToastContext.Provider value={showToast}>
      ...
      {message && (
        <div
          role="status"
          aria-live="polite"
          className={`pointer-events-none fixed left-1/2 top-4 z-50 -translate-x-1/2 rounded-panel border border-subtle bg-ink px-4 py-2 text-sm font-bold text-paper shadow-soft transition-opacity duration-150 motion-reduce:transition-none ${
