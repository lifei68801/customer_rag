  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <form
        ...
        className="flex flex-col gap-3 border-2 border-ink bg-card p-4 shadow-soft"
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          {pendingJobs.map((job) =>
            job.is_stuck ? (
              <div
                key={job.job_id}
                className="flex items-center justify-between border-2 border-status-error bg-card px-4 py-3 shadow-soft-sm"
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`min-h-[44px] cursor-pointer border-2 border-ink bg-accent-pink px-3 py-1.5 text-sm font-bold text-ink shadow-soft-sm transition active:translate-x-px active:translate-y-px active:shadow-none disabled:cursor-not-allowed disabled:opacity-50 ${focusRing}`}
                  >
                  ...
                  <button
                    ...
                    disabled={jobActionId !== null}
                    className={`min-h-[44px] cursor-pointer border-2 border-ink bg-paper px-3 py-1.5 text-sm font-bold text-ink shadow-soft-sm transition active:translate-x-px active:translate-y-px active:shadow-none disabled:cursor-not-allowed disabled:opacity-50 ${focusRing}`}
                  >
        ...
        {loaded &&
          documents.map((doc) => {
            ...
            return (
              <div
                key={doc.file_path}
                className={`flex flex-col gap-2 border-2 border-ink bg-card shadow-soft-sm ${
