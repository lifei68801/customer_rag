        ...
        terms.map((term) => {
          ...
          return (
            <div
              ...
              className={`flex flex-col gap-3 border-2 border-ink bg-card shadow-soft-sm ${
                ...
                <>
                  <div className="flex flex-wrap gap-3">
                    <input
                      ...
                      className="min-w-[10rem] flex-1 border-2 border-ink bg-paper px-3 py-2 text-ink placeholder:text-ink-soft focus:shadow-soft focus:outline-none"
                    />
                    <input
                    ...
                    <select
                      ...
                      className="min-w-[8rem] flex-1 border-2 border-ink bg-paper px-3 py-2 text-ink focus:shadow-soft focus:outline-none"
                    >
